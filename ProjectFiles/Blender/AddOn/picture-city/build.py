...
destination_path = 'G:/Bachelor/SVN/ProjectFiles/Blender/AddOn/Build/'
...
if destination_path[-1] in ['/', '\\']:
    destination_path += "picture-city-v" + version_number + "/"
else:
    destination_path += "/picture-city/" + version_number + "/"
